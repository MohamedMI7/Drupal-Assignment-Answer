...
class __TwigTemplate_e4f276da0cd0ab96e1be992126595f00 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 31, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button--split.html.twig", "C:\\xampp\\htdocs\\Daily_News\\web\\themes\\contrib\\bootstrap\\templates\\input\\input--button--split.html.twig");
    }
